...
1. Describe the biggest difference between `.forEach` & `.map`.
    forEach runs a loop through the existing array
    map creates a new array
2. What is the difference between a function and a method?
    A function is called by name / All data is passed
...
5. Why do we need super() in an extended class?
    Replaces call() and gives the extending class all the previous attributes of the parent class.
## Project Set up
